...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, OWMod.MOD_ID);

    // Регистрируем PebblesBlock вместо обычного Block
    public static final RegistryObject<Block> PEBBLES = registerBlock("pebbles",
            () -> new PebblesBlock(BlockBehaviour.Properties.copy(Blocks.STONE).noCollission().instabreak().noOcclusion().sound(SoundType.STONE)));
